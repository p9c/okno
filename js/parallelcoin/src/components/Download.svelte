...
<div id="download" class="step slide" data-x="164" data-y="-160" data-scale="0.05" _data-autoplay="10">
  <div class="w-slide h-slide flex flex-col justify-center items-center">


    <!-- partial:index.partial.html -->
    <div class="stage p-20">
      <Shadow>DOWNLOAD PARALLELCOIN WALLET</Shadow>
      <p>Download application for your preferred system.</p>
      <p>
